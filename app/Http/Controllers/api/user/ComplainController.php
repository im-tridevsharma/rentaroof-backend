    ...
    public function store(Request $request)
    {
        ...
        if ($user) {
            ...
            if ($complain->save()) {
                ...
                $an->content = 'New complain has been generated by user: ' . $complain->fullname;
                $an->type  = 'Normal';
                $an->title = 'Complain Raised';
                $an->redirect = '/admin/complains';
                $an->save();
                ...
                $user_notify->title = 'Complains Raised';
                $user_notify->content = 'You successfully generated a complain. We will notify you when gets any update on this.';
